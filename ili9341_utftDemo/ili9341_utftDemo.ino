...
void ILI9341duenodelay()
{
	...
	//ILI9341due NEW
	tft.fillRect((int16_t)0, (int16_t)0, (uint16_t)320, (uint16_t)15, (uint16_t)RED);
	tft.setTextColor(WHITE, RED);
	tft.printAlignedOffseted(F("* ILI9341_due UTFT 240x320 Demo *"), gTextAlignTopCenter, 0, 3);
	tft.fillRect((int16_t)0, (int16_t)226, (uint16_t)320, (uint16_t)240, tft.color565(64, 64, 64));
	...
	//ILI9341due NEW
	tft.fillRect((int16_t)1, (int16_t)16, (uint16_t)318, (uint16_t)209, (uint16_t)BLACK);
	...
	//ILI9341due NEW
	tft.fillRect((int16_t)1, (int16_t)16, (int16_t)318, (int16_t)209, (uint16_t)BLACK);
	...
	for (int i = 1; i < 6; i++)
	{
		...
		tft.fillRect((int16_t)70 + (i * 20), (int16_t)30 + (i * 20), (uint16_t)60, (uint16_t)60, color);
	}
	//delay(2000);
	...
	//ILI9341due NEW
	tft.fillRect((int16_t)0, (int16_t)0, (uint16_t)320, (uint16_t)240, (uint16_t)BLUE);
