...
enum Orientation {portrait=0,landscape=1, portrait_reverse=2, landscape_reverse=3};
...
public:
    ...
    uint8_t mode;			 // PORTRAIT (X==CHANELX) /LANDSCAPE (X==CHANELY)
    Touch(uint8_t _mode=TOUCH_LANDSCAPE) : mode(_mode) { };
